  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const payload = {
        ...
        quantityRequired: formData.quantityRequired ? Number(formData.quantityRequired) : null,
        unit: formData.unit,
      };
      ...
      <Paper sx={{ p: 4, boxShadow: 3, borderRadius: 2 }}>
        ...
        <form onSubmit={handleSubmit}>
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={6}>
              <FormControl fullWidth required error={!!error && !formData.unit} disabled={loading}>
